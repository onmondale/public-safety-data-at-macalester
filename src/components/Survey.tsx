    ...
    <div className="contentContainer">
      ...
      <section className="contentSection">
        ...
        <div className="sectionContent surveyReasoning">
          ...
          <p>
            Pagano, Monica B., et al. "How do we design and report a high‐quality survey?." Transfusion 60.10 (2020): 2178-2184. https://onlinelibrary.wiley.com/doi/abs/10.1111/trf.15861
          </p>
          <p>
            “Writing Survey Questions.” Pew Research Center, 26 May 2021, www.pewresearch.org/writing-survey-questions/.
          </p>
        </div>
      </section>
    </div>
